...
# Name: Kevin Cherry
# Date: 2020-10-31
# Description: Paper piano module for visualizing samples. DO NOT MODIFY.
#
# Usage for Paper Piano Assignment:
# -----------------------------------------------------------------
# add the following line of code at the top of your paper piano file:
#   from waveform_vis import WaveformVis
#
# now in your build_samples function, after generating your samples,
# add the following lines of code
#    vis = WaveformVis()
#    vis.visSamples(samples, "Square") # replace "Square" with the
#                                      # appropriate waveform name
#                                      # such as "Sawtooth" or "Triangle"
#########################################################################
from tkinter import *
...
class WaveformVis(Canvas):
  ...
  def visSamples(self, samples, waveformName, color = 'blue', axisAndTitleColor = 'black'):
    ...
    wfFont = font.Font(family='Times New Roman', size=18)
    self.create_text(WaveformVis.WIDTH // 2, 30, font=wfFont, text=waveformName.title(), fill=axisAndTitleColor)
